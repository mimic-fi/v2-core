...
<p align="center">
  <a href="https://badge.fury.io/js/@mimic-fi%2Fv2-permissions-manager">
    <img src="https://badge.fury.io/js/@mimic-fi%2Fv2-permissions-manager.svg" alt="NPM">
  </a>
...
This package contains the Permissions Manager contracts use in order to manage the different permissions related
to a Mimic Smart Vault.
...
$ cd v2-core/packages/permissions-manager
